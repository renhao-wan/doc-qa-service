...
export function findMarkdownFilePageList(current, size, fileName, startDate, endDate) {
    return axios.post("/knowledge-base/md/list", {current, size, fileName, startDate, endDate})
}

// 上传问答文件分片
export function uploadFileChunk(form, timeout = 30000) {
    return axios.post("/knowledge-base/file/upload-chunk", form, {
...
export function mergeFileChunk(fileMd5, timeout = 30000) {
    return axios.post("/knowledge-base/file/merge-chunk", { fileMd5 }, {
        timeout: timeout // 自定义超时时间，默认30s
    })
}
...
export function checkFile(fileMd5) {
    return axios.post("/knowledge-base/file/check", { fileMd5 })
}

// 删除 Markdown 问答文件
export function deleteMarkdownFile(id) {
    return axios.post("/knowledge-base/md/delete", { id })
}

// 修改 Markdown 问答文件
export function updateMarkdownFile(record) {
    return axios.post("/knowledge-base/md/update", record)
}
